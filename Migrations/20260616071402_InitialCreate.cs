        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordSalt = table.Column<string>(type: "nvarchar(225)", maxLength: 225, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualSalesAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashShifts", x => x.ShiftId);
                    table.ForeignKey(
                        name: "FK_CashShifts_Staffs_StaffId",
                        column: x => x.StaffId,
                        principalTable: "Staffs",
                        principalColumn: "StaffId");
                    table.ForeignKey(
                        name: "FK_CashShifts_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "StoreId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreStocks", x => x.StockId);
                    table.ForeignKey(
                        name: "FK_StoreStocks_ProductVariants_VariantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sales_CashShifts_ShiftId",
                        column: x => x.ShiftId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashShifts_StaffId",
                table: "CashShifts",
                column: "StaffId");

            migrationBuilder.CreateIndex(
                name: "IX_CashShifts_StoreId",
                table: "CashShifts",
                column: "StoreId");
